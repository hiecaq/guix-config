...
*** Packages
On Android and Windows, I currently just use =package.el=.
#+begin_src emacs-lisp
...
*** Fonts
#+begin_src emacs-lisp
  (defun my-faces-initialize (&rest _)
...
#+begin_src emacs-lisp
  (setup org
    (defun my-org-evil-save-modified-and-close ()
      (interactive)
...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-org-roam-ql
    (let ((commit "d891f9a184dd79ad00d064131ace292d22254c32")
      ...
      (package
       ...
       (source
        (origin
         ...
         (sha256
          (base32
           "1fkzyp0b2s4phw4483mpaxwm7380r926l6wy4qrvgjkyjmgagwnq"))))
       (build-system emacs-build-system)
       (propagated-inputs
...
#+begin_src emacs-lisp
  (setup org-roam
    (defun my-roam-link-make-string (desc type)
      (let* ((node (car (org-roam-ql-nodes `(and (level 0) (file-title ,desc 'exact)))))
...
#+begin_src emacs-lisp
  (setup org-roam-dailies
    (defvar my-org-roam-dailies-prelude
      (string-join
       '("#+title: %<%Y-%m-%d>"
         ...
         ""
         "* Done"
         "#+begin: org-roam-ql :query (and (todo \"DONE\") (closed > \"%<%Y-%m-%d>T04:00:00\") (closed < \"%<%Y-%m-%d>T04:00:00\")) :columns (file-title title closed) :sort \"closed\""
         "#+end:"
         "")
       "\n")
    ...
    (:with-map my-global-consult-map
      (:bind "L" #'my-org-roam-dailies-log-today-with-context)))
#+end_src
