...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-difftastic-el
    (let ((commit "63d31f62617da25b9c77afd0fe88b26e095d506d")
          (last-release-version "0.0.0") ;; from the el file version header
          (revision "0")
          (url "https://github.com/pkryger/difftastic.el"))
      (package
        (name "emacs-difftastic-el")
        (version (git-version last-release-version revision commit))
        (source
         (origin
           (method git-fetch)
           ...
           (sha256
            (base32
             "105q2477lwhfzhrgpc6nhjxax868nv28k8kif2q27djsh9i37wh4"))))
        (propagated-inputs
         (list upstream:emacs-compat upstream:emacs-magit upstream:emacs-transient))
        (inputs (list difftastic))
        (build-system emacs-build-system)
        (arguments
         (list
          #:tests? #f
          ...
          #~(modify-phases %standard-phases
              (add-after 'unpack 'embed-path-to-difft
                (lambda* (#:key inputs #:allow-other-keys)
                  (emacs-substitute-variables "difftastic.el"
                    ("difftastic-executable" (search-input-file inputs "/bin/difft"))))))))
        (home-page url)
        (synopsis "Wrapper for difftastic")
        (description "This Emacs package is designed to integrate @code{difftastic} - a
  ...
  @code{difftastic}'s output within Emacs using faces from your user theme,
...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-org-roam-ql
    (let ((commit "92730786c21743365985017a6d9a0de9a45d9ffd")
      ...
      (package
       ...
       (source
        (origin
         ...
         (sha256
          (base32
           "09qy9vsj8qpdy88iysyqnm1slamgqsjca98avqqsca4qgpwxjjhg"))))
       (build-system emacs-build-system)
       (propagated-inputs
