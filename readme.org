...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-pcre2el-next
    (let ((commit "b941ed8a96299868171fac625ecffec77de3e986")
          (last-release-version "1.11")
          (revision "0"))
      (package
       (inherit upstream:emacs-pcre2el)
       (name "emacs-pcre2el-next")
...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-evil-collection-next
    (let ((commit "286d69de179cf70c00963a998a4beb826b51414a")
