...
- [[https://emacs-china.org/t/topic/5362][Discussion on Tweaking Eshell]]  in Emacs China (in Chinese)
      ...
      (package
        ...
        (source
         (origin
           ...
           (sha256
            (base32
             "0dvqs1jg5zqn0i3r67sn1a40h5rm961q9vxvmqxbgvdhkjvip8fn"))))
        (build-system emacs-build-system)
        (arguments
         '(#:include '("emacsql.el" "emacsql-compiler.el")))
        (home-page url)
...
Reference:
- How To Take Smart Notes by Sönke Ahrens
- [[https://blog.jethro.dev/posts/how_to_take_smart_notes_org/][How To Take Smart Notes With Org-mode]] by Jethro Kuan, the author of org-roam
...
***** Org Roam
[[https://www.orgroam.com/][org-roam]] basically does 2 things:
      ...
      (package
        ...
        (source
         (origin
           ...
           (sha256
            (base32
             "0vhl69y6yk2zzfixjdwr8vxl2k921h0syshk5123r1nm9jp3i1s9"))))
        (propagated-inputs
...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-consult-org-roam-next
    (let ((commit "3c2701ee72130591f9e8c48a9d54e544c304003b")
      ...
      (package
        ...
        (source
         (origin
           ...
           (sha256
            (base32
             "1kn7shcdy6n6xzwbg954nbwvwifc0r82dl0lnxhh8rg4d6xwwgq2"))))
...
#+begin_src emacs-lisp
  (setup org-roam
    (:option org-roam-database-connector 'sqlite-builtin
             org-roam-db-location (exdg-data "org/org-roam.db")
...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-citar-next
    (let ((commit "ea489eca7f5321b5ede1ea294abf47ecbc9f11ca")
      ...
      (package
        ...
        (source
         (origin
           ...
           (sha256
            (base32
             "0lyirl5ynyikrwlvfga5y6qp2rxkm44xax6vy73aqpalhi95apa1")))))))
#+end_src

#+begin_src emacs-lisp
  (setup citar
    (:option
     org-cite-global-bibliography (list (expand-file-name "calibre.bib" (xdg-user-dir "DOCUMENTS")))
...
#+begin_src scheme :tangle "build/hiecaq/packages/emacs-xyz.scm" :noweb-ref nil
  (define-public emacs-citar-org-roam-next
    (let ((commit "2ae351d15e0847a4aed06e7f5d472dd41d15bea0")
      ...
      (package
       ...
       (source
        (origin
         ...
         (sha256
          (base32
           "0zvwc3853pv8hz29858v5yp52k5qzhlj8v6v4zvd4k3zyalcik5w"))))
